...
Original file is located at
    https://colab.research.google.com/drive/17yKD4TtNvtptukXoJYY3BNTLypqrY4Br
"""
...
model.load_state_dict(torch.load("models/segformer_epoch25_final.pt"))
model.to(device)
...
plt.imsave(prediction, "pred{}.png".format(index))
plt.imsave(target, "gt{}.png".format(index))
