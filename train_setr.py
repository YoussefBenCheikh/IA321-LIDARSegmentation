    ...
    if epoch + 1 == nb_epochs or miou > best_miou:
      for key, class_iou in zip(class_encoding.keys(), iou):
        ...
        if miou > best_miou:
          ...
          best_miou = miou
          torch.save(model.state_dict(), "TrainedModels/setr_epoch{}.pt".format(epoch+1))


torch.save(model.state_dict(), "TrainedModels/setr_epoch{}_final.pt".format(nb_epochs))
